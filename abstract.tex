...
The second is that we didn't decide on a project leader.
As a result, the environment is realized in which all members have a responsibility and we are easy to work.
